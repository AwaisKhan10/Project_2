...
export default function Seller() {
    ...
    try {
      ...
      if (editMode) {
        const response = await axios.patch(
          `https://mrbookupdated.onrender.com/api/bestseller-update/${selectedCardId}`,
          postData,
          {
            headers: {
        ...
        const response = await axios.post(
          'https://mrbookupdated.onrender.com/api/bestseller',
          postData,
          {
            headers: {
              'Content-Type': 'multipart/form-data',
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('https://mrbookupdated.onrender.com/api/bestseller-get');
  ...
  const handleDelete = async (cardId) => {
    try {
      const response = await axios.delete(
        `https://mrbookupdated.onrender.com/api/bestseller-delete/${cardId}`
      );
